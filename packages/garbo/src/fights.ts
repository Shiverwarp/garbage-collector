...
function familiarSpec(underwater: boolean, fight: string): OutfitSpec {
  if (!underwater) {
    if (
      ...
      // switch monster doesn't apply ML, meaning we die too quickly to get multiple eggs in
...
const freeRunFightSources = [
      ...
      spec: {
        bonuses: new Map([
          [
            ...
            mallPrice($item`gingerbread cigarette`) * 0.04,
          ],
        ]),
      },
    },
  ...
  new FreeRunFight(
    ...
    },
    {
      spec: {
        modifier: ["sprinkles"],
        equip: $items`carnivorous potted plant`,
      },
    },
  ),
  new FreeFight(
    ...
    },
    {
      spec: () => {
        ...
        const spec: OutfitSpec = {
          ...
          bonuses: new Map([[$item`carnivorous potted plant`, 1000]]),
