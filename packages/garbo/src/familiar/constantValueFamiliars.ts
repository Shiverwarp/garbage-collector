      ...
      Robortender.dropChance() *
        garboValue(
          Robortender.dropFrom(
            mode === "target" ? globalOptions.target : $monster.none,
          ),
        ) +
